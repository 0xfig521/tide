  ...
  en: {
    ...
    features: {
      ...
      items: [
        ...
        { title: "Daemon Mode", description: "Background scheduled fetching that persists across terminal sessions. Set it and forget it. Auto-records failures for triage." },
        { title: "Performance Optimized", description: "Batch transactional inserts, prepared statement reuse, and token-efficient output. Built for scale." },
      ],
    },
  ...
  zh: {
    ...
    features: {
      ...
      items: [
        ...
        { title: "守护进程模式", description: "跨终端会话的后台定时抓取。设置一次即可。自动记录失败供分析排查。" },
        { title: "性能优化", description: "批量事务写入、预编译语句复用、token 高效输出。为大规模数据而生。" },
      ],
    },
